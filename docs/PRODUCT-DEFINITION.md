...
| 13 | 个人微信集成 | **V1 不做** (只替代企微内部), V2 再评估合规路径 (企微外部联系人 vs Wechaty 灰色). V1 工期 +3 周加移动端 |
| 14 | 设计语言基准 | **苹果 + 微软级别**: SF Pro/PingFang 字体 · 8pt 网格 · 玻璃拟态 · 语义化动效 · WCAG AA 可访问性 · 详见 `docs/UI-IA.md` §5 |
...
- **MANIFESTO 20 条宪章 v2.0**: 永远不可改 (V2/V3 都遵守)
