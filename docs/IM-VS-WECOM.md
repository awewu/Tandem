...
## 2. 8 天 P0 路线 — **全部一口气干完了 (2026-05-10 单次 session)**

```
✅ Day 1   建群对话框 (7 类型 / 部门/项目/跨部门)         [d05fa1e]
✅ Day 2   通讯录树 (三级折叠 / 搜索 / 一键 DM/建群)        [e37be0b]
✅ Day 3   联动 polish (prefill 部门 / SSE channel 事件)   [本次]
✅ Day 4   撤回 (2分钟 / admin) + 已读人数 UI               [本次]
✅ Day 5-6 群成员管理 (加/移除/角色 owner-admin-member)    [本次]
✅ Day 7   群公告 (markdown) + pinned 消息 (最多 5 条)     [本次]
✅ Day 8   联调 (tsc 0 errors / GET /im 200)               [本次]
```

P0 走完 → IM 完整度 25% → **70%** (覆盖 9/12 P0+P1 项).
