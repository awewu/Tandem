...
| `COMPETITIVE-DEEP-DIVE-2026-05-30.md` ★ | **企业级 AI 深度对比** (Linear/Notion/Claude/Coze/Copilot × 功能细节+技术架构+页面架构+学习清单 4 维 / 综合 20 项学习清单 + 90 天预算分配 + 3 条不可逾越红线) ⚠️ 自评: 20 项偏 wishlist, 见 COMPETITIVE-CLAUDE-CODE-CODEX-DEEP 精简 4 件 |
| `COMPETITIVE-CLAUDE-CODE-CODEX-DEEP-2026-05-30.md` ★ | **Claude Code + Codex 深层架构与产品逻辑** (7 个底层架构决策 + Code/Codex 差异 + 3 个产品逻辑洞见 + 真该借 4 件 + 不该借 3 件 + 一句话总结 harness is the moat) |
