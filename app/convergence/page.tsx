    ...
    <div className="rounded-2xl border border-border bg-surface-1 p-3 shadow-soft-sm">
      ...
      <div className="relative mb-2">
        ...
        <input
          ...
          className="w-full rounded-2xl border border-border bg-surface-2 py-2 pl-8 pr-3 text-caption text-ink-primary outline-none placeholder:text-ink-tertiary focus:border-brand-300 focus:ring-2 focus:ring-brand-100 disabled:opacity-60"
        />
      </div>
          ...
          {filtered.map((item) => {
            ...
            return (
              <button
                ...
                disabled={disabled}
                className={cn(
                  'flex w-full min-w-0 items-start gap-3 rounded-2xl border px-3 py-2 text-left transition-colors disabled:cursor-not-allowed disabled:opacity-60',
                  active
