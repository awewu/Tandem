...
export const GET = withApiLog(GETApiHandler, { route: '/api/1on1/[id]' });
...
export const PATCH = withApiLog(PATCHApiHandler, { route: '/api/1on1/[id]' });
...
export const DELETE = withApiLog(DELETEApiHandler, { route: '/api/1on1/[id]' });
