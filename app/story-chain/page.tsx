  ...
  return (
    <section className="mb-4 rounded-2xl border bg-surface-1 p-3 shadow-soft-sm">
      ...
      <input
        ...
        className="mb-2 w-full rounded-xl border border-border bg-surface-2 px-3 py-2 text-caption text-ink-primary outline-none placeholder:text-ink-tertiary focus:border-brand-300 focus:ring-2 focus:ring-brand-100"
      />
          ...
          {filteredAnchors.map((a) => {
            ...
            return (
              <button
                ...
                className={[
                  'flex w-full min-w-0 items-start gap-3 rounded-xl border px-3 py-2 text-left transition-colors',
                  active
