...
export function createInMemoryStore(): TandemStore {
  return instrumentBusinessRepositories({
    ...
    pmsFollowUps: new InMemoryRepository(),
    pmsDuplicateChecks: new InMemoryRepository(),
    pmsPriceApplications: new InMemoryRepository(),
    pmsContracts: new InMemoryRepository(),
    pmsPublicPool: new InMemoryRepository(),
    pmsApprovals: new InMemoryRepository(),
    pmsAlerts: new InMemoryRepository(),
    pmsNotificationRules: new InMemoryRepository(),
    pmsDeliveryOrders: new InMemoryRepository(),
    pmsDeliveryTasks: new InMemoryRepository(),
    pmsAcceptanceRecords: new InMemoryRepository(),
    pmsCommissioningRecords: new InMemoryRepository(),
    pmsMaintenanceRecords: new InMemoryRepository(),
    pmsDealerOrgs: new InMemoryRepository(),
    pmsDealerQualifications: new InMemoryRepository(),
    pmsServiceAssignments: new InMemoryRepository(),
    pmsEquipmentSNs: new InMemoryRepository(),
    pmsEquipmentTelemetry: new InMemoryRepository(),
    pmsRebatePolicies: new InMemoryRepository(),
    pmsRebateAccruals: new InMemoryRepository(),
    pmsDealerOrders: new InMemoryRepository(),
    pmsCustomerFeedback: new InMemoryRepository(),
    pmsDuplicateAppeals: new InMemoryRepository(),
    pmsDealerHealthScores: new InMemoryRepository(),
    pmsPerformanceTargets: new InMemoryRepository(),
    pmsDemandGenLeads: new InMemoryRepository(),
    pmsKeyProductCampaigns: new InMemoryRepository(),
    pmsProductCatalog: new InMemoryRepository(),
    pmsCustomerAccounts: new InMemoryRepository(),
    pmsQuoteRecommendations: new InMemoryRepository(),
  });
}
