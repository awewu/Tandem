...
export function createDrizzleStore(): TandemStore {
  return instrumentBusinessRepositories({
    ...
    shouchaoAttachments: new DrizzleKvRepository('shouchao_attachments'),
    shouchaoDatabases: new DrizzleKvRepository('shouchao_databases'),
    shouchaoRows: new DrizzleKvRepository('shouchao_rows'),
    shouchaoDistillCandidates: new DrizzleKvRepository('shouchao_distill_candidates'),
    knowledgeNodes: new DrizzleKvRepository('knowledge_nodes'),
    driveDistillationCandidates: new DrizzleKvRepository('drive_distillation_candidates'),
    ...
    pmsFollowUps: new DrizzleKvRepository('pms_follow_ups'),
    pmsDuplicateChecks: new DrizzleKvRepository('pms_duplicate_checks'),
    pmsPriceApplications: new DrizzleKvRepository('pms_price_applications'),
    pmsContracts: new DrizzleKvRepository('pms_contracts'),
    pmsPublicPool: new DrizzleKvRepository('pms_public_pool'),
    pmsApprovals: new DrizzleKvRepository('pms_approvals'),
    pmsAlerts: new DrizzleKvRepository('pms_alerts'),
    pmsNotificationRules: new DrizzleKvRepository('pms_notification_rules'),
    pmsDeliveryOrders: new DrizzleKvRepository('pms_delivery_orders'),
    pmsDeliveryTasks: new DrizzleKvRepository('pms_delivery_tasks'),
    pmsAcceptanceRecords: new DrizzleKvRepository('pms_acceptance_records'),
    pmsCommissioningRecords: new DrizzleKvRepository('pms_commissioning_records'),
    pmsMaintenanceRecords: new DrizzleKvRepository('pms_maintenance_records'),
    pmsDealerOrgs: new DrizzleKvRepository('pms_dealer_orgs'),
    pmsDealerQualifications: new DrizzleKvRepository('pms_dealer_qualifications'),
    pmsServiceAssignments: new DrizzleKvRepository('pms_service_assignments'),
    pmsEquipmentSNs: new DrizzleKvRepository('pms_equipment_sns'),
    pmsEquipmentTelemetry: new DrizzleKvRepository('pms_equipment_telemetry'),
    pmsRebatePolicies: new DrizzleKvRepository('pms_rebate_policies'),
    pmsRebateAccruals: new DrizzleKvRepository('pms_rebate_accruals'),
    pmsDealerOrders: new DrizzleKvRepository('pms_dealer_orders'),
    pmsCustomerFeedback: new DrizzleKvRepository('pms_customer_feedback'),
    pmsDuplicateAppeals: new DrizzleKvRepository('pms_duplicate_appeals'),
    pmsDealerHealthScores: new DrizzleKvRepository('pms_dealer_health_scores'),
    pmsPerformanceTargets: new DrizzleKvRepository('pms_performance_targets'),
    pmsDemandGenLeads: new DrizzleKvRepository('pms_demand_gen_leads'),
    pmsKeyProductCampaigns: new DrizzleKvRepository('pms_key_product_campaigns'),
    pmsProductCatalog: new DrizzleKvRepository('pms_product_catalog'),
    pmsCustomerAccounts: new DrizzleKvRepository('pms_customer_accounts'),
    pmsQuoteRecommendations: new DrizzleKvRepository('pms_quote_recommendations'),
  });
}
