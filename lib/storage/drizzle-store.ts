...
export function createDrizzleStore(): TandemStore {
  return instrumentBusinessRepositories({
    ...
    reportViewPreferences: new DrizzleKvRepository('report_view_preferences'),
    reportSummaries: new DrizzleKvRepository('report_summaries'),
    ...
    legalDocuments: new DrizzleKvRepository('legal_documents'),
    ...
    workflowForms: new DrizzleKvRepository('workflow_forms'),
    workflowTemplates: new DrizzleKvRepository('workflow_templates'),
    workflowBindings: new DrizzleKvRepository('workflow_bindings'),
    workflowFormInstances: new DrizzleKvRepository('workflow_form_instances'),
    workflowInstances: new DrizzleKvRepository('workflow_instances'),
    ...
    // PMS 不走仓储抽象 (lib/pms/*-service.ts 直连 drizzle typed 表 pms_*).
  });
}
