/**
 * LoadCalculationEngineV3.js — moved to shared HVAC calculation kernel.
 *
 ...
 */
module.exports = require('../../packages/domain/hvac-kernels/load-calculation/LoadCalculationEngineV3');
