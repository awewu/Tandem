/**
 * AirConditioningEngine.js — moved to shared HVAC calculation kernel.
 *
 ...
 */
module.exports = require('../../packages/domain/hvac-kernels/air-conditioning/AirConditioningEngine');
