...
export function HermesHealth({ compact = false }: { compact?: boolean }) {
  ...
  if (compact) {
    return (
      <button
        ...
        className="flex items-center gap-2 px-2 py-1 rounded-md hover:bg-muted text-footnote"
      >
  ...
  return (
    <div className="flex items-center gap-3 rounded-lg border bg-card p-3 text-caption">
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="text-footnote text-muted-foreground truncate" title={info}>
